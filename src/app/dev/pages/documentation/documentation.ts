...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">mukesh888 is an application template for Angular and is distributed as a CLI project. Current versions is Angular v20 with PrimeNG v20. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
<code>npm install -g &#64;angular/cli</code></pre>
            ...
            <pre class="app-code">
<code>git clone https://github.com/mukesh888/mukesh888
npm install
ng serve</code></pre>
